...
from views import nueva_historia_clinica, historia_clinica_controlado_edit,  nueva_historia_clinica_controlada, ListasHistoriasPorUser, Plan_TratamientoHC,Plan_EjecucionHC , nueva_historia_clinica_integral, historia_clinica_edit, historia_clinica_integral_edit
...
urlpatterns = [
    ...
    url(r'^controlada/editar/(?P<pk>\d+)/$',  historia_clinica_controlado_edit,  name='editar_controlado'),
     url(r'^integral/editar/(?P<pk>\d+)/$',  historia_clinica_integral_edit,  name='editar_integral'),
    ...
    url(r'^historiaClinica/(?P<pk>\d+)/plantratamiento', login_required(Plan_TratamientoHC.as_view()),  name='plan-tratamiento'),
